...
<html lang="en">
   ...
   <body class='pace-top'>
      <div id="app" class="app app-full-height app-without-header">
         <div class="register">
            <div class="register-content">
               <form id="signup">
                    <hr>
                  <center><img src="assets/images/login.png" ></center>
                  <hr>
                  ...
                  <div class="text-white text-opacity-50 text-center">
                     Sudah Punya Akun Portfi? <a href="/dashboard/login">Login</a>
                  </div>
               </form>
            </div>
         </div>
      ...
      <script type="d0f64290b5c55f95e2777a1e-text/javascript">
