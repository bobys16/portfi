        		...
        		<div class="card">
        			<div class="card-header d-flex flex-row justify-content-between py-15px">
        				<div class="d-flex flex-column">
        					<div class="fw-bold fs-16px">Education List</div>
        					<p class="text-theme">* You can only view your Education only. add, delete and edit will be implement on the next update. ( Dummy Data )</p>
        				</div>
        			...
        			<div class="card-body">
        				<table id="datatableDefault" class="table table-bordered text-nowrap w-100">
        					...
        					<tbody>
        					    <?php 
                                    $work = json_decode($porto['porto_detail']['education'], true);
