      ...
      <div class="card">
         <div class="card-header d-flex flex-row justify-content-between py-15px">
            <div class="d-flex flex-column">
               <div class="fw-bold fs-16px">Work Experience List</div>
               <p class="text-theme">* You can only view your job experience only. add, delete and edit will be implement on the next update. ( Dummy Data )</p>
            </div>
         ...
         <div class="card-body">
            <table id="datatableDefault" class="table table-bordered text-nowrap w-100">
               ...
               <tbody> <?php 
                                    $work = json_decode($porto['porto_detail']['work'], true);

                                    foreach ($work as $index => $job) {
                                ?> <tr>
                     <td> <?=  $job['id'];?> </td>
                     <td class="text-center">
                        <span class="badge bg-theme"> <?=  $job['as_what'];?> </span>
                     </td>
                     <td class="text-center"> <?=  $job['where'];?> </td>
