        		...
        		<div class="card">
        			<div class="card-header d-flex flex-row justify-content-between py-15px">
        				<div class="d-flex flex-column">
        					<div class="fw-bold fs-16px">Skill List</div>
        					<p class="text-theme">* You can only view your Skill only. add, delete and edit will be implement on the next update. ( Dummy Data )</p>
        				</div>
        				...
        				<table id="datatableDefault" class="table table-bordered text-nowrap w-100">
        					<thead class="table-dark">
        						<tr>
        							...
        							<th class="text-center">Knowledge Percentage</th>
        					...
        					<tbody>
        					    <?php 
                                    $work = json_decode($porto['porto_detail']['skill'], true);
        						...
        						<tr>
        							...
        							<td class="text-center">
        								<span class="badge bg-theme"><?=  $job['skill_name'];?></span>
        							</td>
        							<td class="text-center"><?=  $job['knowledge_percentage'];?></td>
        							<td class="text-center">
