      ...
      <div class="card">
         <div class="card-header d-flex flex-row justify-content-between py-15px">
            <div class="d-flex flex-column">
               <div class="fw-bold fs-16px">Portofolio List</div>
               <p class="text-theme">* You can only view your Portofolio list only. add, delete and edit will be implement on the next update. ( Dummy Data )</p>
            </div>
         ...
         <div class="card-body">
            <table id="datatableDefault" class="table table-bordered text-nowrap w-100">
               <thead class="table-dark">
                  <tr>
                     <th class="text-center">Porto ID</th>
                     <th class="text-center">Title</th>
                     <th class="text-center">Desc</th>
                     <th class="text-center">Demo Link</th>
                     <th class="text-center">Action</th>
                  </tr>
               </thead>
               <tbody> <?php 
                                    $work = json_decode($porto['porto_detail']['portofolio'], true);

                                    foreach ($work as $index => $job) {
                                ?> <tr>
                     <td> <?=  $job['id'];?> </td>
                     <td class="text-center">
                        <span class="badge bg-theme"> <?=  $job['title'];?> </span>
                     </td>
                     <td class="text-center"> <?=  $job['description'];?> </td>
                     <td class="text-center"> <?=  $job['demo_link'];?> </td>
                     <td class="text-center">
